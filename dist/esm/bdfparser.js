...
export class Font {
            ...
            try {
                ...
                if (typeof Deno !== 'undefined') {
                    ...
                    if (this.__f !== undefined) {
                        try {
                            for (var _d = true, _e = __asyncValues(this.__f), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                                _c = _f.value;
                                _d = false;
                                try {
                                    const _ = _c;
    ...
    *iterglyphs(order, r) {
    ...
    drawcps(cps, options = {}) {
        ...
        const _bb = (_f = options.bb) !== null && _f !== void 0 ? _f : null;
        ...
        const dire = (_g = DIRE_SHORTCUT_MAP[_direction]) !== null && _g !== void 0 ? _g : _direction;
        ...
        while (1) {
            if (skip) {
                ...
                cp = (_h = cpsiter.next()) === null || _h === void 0 ? void 0 : _h.value;
                if (cp === undefined) {
                    break;
                }
...
export class Bitmap {
    ...
    shadow(xoff, yoff) {
        ...
        const bitmap_shadow = this.clone(), w = this.width(), h = this.height();
